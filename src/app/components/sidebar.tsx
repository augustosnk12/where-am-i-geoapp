    ...
    >
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-2">
          ...
          />
          <div
            className={`text-lg text-grey-700 font-bold font-sans transition-opacity duration-300 ${isDisplayingFullWidth ? "opacity-100" : "opacity-0"
              }`}
          >
            Marques Maps
          </div>
         ...
         <LiaTimesSolid
          className={`text-black transition-opacity duration-300 cursor-pointer hover:text-blue-500 ${isDisplayingFullWidth ? "opacity-100" : "opacity-0"
            }`}
          size={24}
      ...
      <form onSubmit={handleSearch} className="w-full">
        <div className="relative w-full mt-8">
          {!search && (
            <FaSearch
              className={!isDisplayingFullWidth ? `absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 text-gray-400 transition-opacity duration-300 hover:border-gray-700` :
          ...
          <div className="flex items-left gap-2">
            <input
              type="text"
              className={!search ? `w-full h-12 border border-gray-300 rounded-lg p-2 pl-10 m-0 text-left transition-all duration-300 ease-in-out hover:border-gray-700` :
                `w-full h-12 border border-gray-300 rounded-lg p-2 pl-4 m-0 text-left transition-all duration-300 ease-in-out hover:border-gray-700`
              }
